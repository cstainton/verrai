...
public class TeaVMWebWorkerTest {
    ...
    public void testWorkerRpcSerialization() {
        ...
        UnitRegistry.getInstance().registerRemote(dev.verrai.integration.service.MyDataService.class.getName(), "teavm-worker", transport);

        // 3. Create a static stub for MyDataService (Generated by processor)
        dev.verrai.integration.service.MyDataService stub = new dev.verrai.integration.service.MyDataService_Stub();
    ...
    public void testCodecEncodingDecoding() {
        ...
        dev.verrai.integration.service.dto.MyDataCodec codec = new dev.verrai.integration.service.dto.MyDataCodec();

        // 1. POJO -> Wire
        dev.verrai.integration.service.dto.proto.MyData wireMsg = codec.toWire(original);
        ...
        try {
            // 3. Bytes -> Wire
            dev.verrai.integration.service.dto.proto.MyData decodedWire = codec.getWireAdapter().decode(encoded);
