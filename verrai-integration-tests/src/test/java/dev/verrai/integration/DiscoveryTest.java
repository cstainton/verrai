...
public class DiscoveryTest {
        ...
        public void testCrossNodeDiscovery() throws Exception {
                ...
                // 1. Setup JVM Node
                dev.verrai.client.service.GlobalUnitBootstrap.SimulatedUnit jvmUnit = dev.verrai.client.service.GlobalUnitBootstrap
                ...
                jvmRegistry.registerLocal("dev.verrai.JvmService", "jvm-impl");

                // 2. Setup Browser Node
                dev.verrai.client.service.GlobalUnitBootstrap.SimulatedUnit browserUnit = dev.verrai.client.service.GlobalUnitBootstrap
                ...
                browserRegistry.registerLocal("dev.verrai.BrowserService", "browser-impl");

                // 3. Setup Worker Node
                dev.verrai.client.service.GlobalUnitBootstrap.SimulatedUnit workerUnit = dev.verrai.client.service.GlobalUnitBootstrap
                ...
                workerRegistry.registerLocal("dev.verrai.WorkerService", "worker-impl");
                ...
                assertTrue("Browser should know WorkerService",
                                browserRegistry.getDiscoverableServiceIdsInstance()
                                                .contains("dev.verrai.WorkerService"));
                ...
                assertTrue("JVM should know BrowserService",
                                jvmRegistry.getDiscoverableServiceIdsInstance()
                                                .contains("dev.verrai.BrowserService"));
                ...
                assertTrue("Browser should know JvmService",
                                browserRegistry.getDiscoverableServiceIdsInstance()
                                                .contains("dev.verrai.JvmService"));
                ...
                assertTrue("JVM should still have its OWN service",
                                jvmRegistry.getDiscoverableServiceIdsInstance().contains("dev.verrai.JvmService"));
        ...
        private EventBus createEventBus(String nodeId) {
                ...
                registerIdentityCodec(bus, dev.verrai.client.service.dto.proto.NodeAnnouncedEvent.class,
                                dev.verrai.client.service.dto.proto.NodeAnnouncedEvent.ADAPTER);
                registerIdentityCodec(bus, dev.verrai.client.service.dto.proto.NodeHeartbeatEvent.class,
                                dev.verrai.client.service.dto.proto.NodeHeartbeatEvent.ADAPTER);
                registerIdentityCodec(bus, dev.verrai.client.service.dto.proto.NodeDepartedEvent.class,
                                dev.verrai.client.service.dto.proto.NodeDepartedEvent.ADAPTER);
                return bus;
        }
