...
public class WebWorkerIntegrationTest {
    ...
    public void testWorkerToJvmRpc() throws InterruptedException {
        ...
        authBootstrap.registerDispatcher("dev.verrai.integration.service.AuthenticationService",
        ...
        dataBootstrap.registerDispatcher("dev.verrai.integration.service.MyDataService",
                new MyDataService_Dispatcher());

        // Register Implementation
        UnitRegistry.register("dev.verrai.integration.service.MyDataService", new MyDataService() {
            @Override
        ...
        UnitRegistry.register("dev.verrai.integration.service.AuthenticationService", new AuthenticationService() {
            @Override
            public AsyncResult<LogonResponse> login(LogonRequest request) {
                logger.info("JVM Server received login for: " + request.getUsername());
                dev.verrai.client.service.AsyncResultImpl<LogonResponse> res = new dev.verrai.client.service.AsyncResultImpl<>();
