...
public class DashboardPage {
    ...
    public void onShow() {
        ...
        demoBtn.setText("DataBinding Demo");
        demoBtn.setType(Button.Type.INFO);
        demoBtn.addClickListener(e -> navigation.goTo("databinding"));
        card.addContent(demoBtn);
