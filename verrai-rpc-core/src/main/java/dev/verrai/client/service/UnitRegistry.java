...
public class UnitRegistry {
    ...
    public void configureStomp(String localNodeId,
        ...
        setTransportResolver(targetNodeId -> new dev.verrai.client.service.transport.StompTransport(client,
        ...
        dev.verrai.client.service.transport.StompTransport eventTransport = new dev.verrai.client.service.transport.StompTransport(
        ...
        registerIdentityCodec(dev.verrai.client.service.dto.proto.NodeAnnouncedEvent.class,
                dev.verrai.client.service.dto.proto.NodeAnnouncedEvent.ADAPTER);
        registerIdentityCodec(dev.verrai.client.service.dto.proto.NodeHeartbeatEvent.class,
                dev.verrai.client.service.dto.proto.NodeHeartbeatEvent.ADAPTER);
        registerIdentityCodec(dev.verrai.client.service.dto.proto.NodeDepartedEvent.class,
        ...
        dev.verrai.client.service.transport.StompTransport serverTransport = new dev.verrai.client.service.transport.StompTransport(
    ...
    public void registerDispatcher(String serviceId,
            dev.verrai.client.service.transport.ServiceDispatcher dispatcher) {
        if (rpcServer != null) {
