...
public class ServiceGenerator {
    ...
    private static final ClassName SERVICE_DISPATCHER = ClassName.get("uk.co.instanto.tearay.rpc.common.transport",
            "ServiceDispatcher");
    private static final ClassName TRANSPORT = ClassName.get("uk.co.instanto.tearay.rpc.common.transport", "Transport");
