...
public class PersistenceProcessor extends AbstractProcessor {
    ...
    private void generateServiceFile() throws IOException {
        FileObject file = filer.createResource(StandardLocation.CLASS_OUTPUT, "",
                "META-INF/services/dev.verrai.persistence.EntityMapper");
    ...
    private String getFromJsHelper(TypeMirror type) {
        ...
        if (str.equals("java.lang.Integer"))
            return "fromJsInteger";
        if (str.equals("java.lang.Double"))
            return "fromJsDoubleWrapper";
        if (str.equals("java.lang.Boolean"))
            return "fromJsBooleanWrapper";
    ...
    private void addHelpers(TypeSpec.Builder builder, ClassName jsObject, ClassName jsBody) {
        ...
        builder.addMethod(MethodSpec.methodBuilder("setProperty")
                ...
                .addAnnotation(AnnotationSpec.builder(jsBody).addMember("params", "{\"obj\", \"key\", \"val\"}")
                        .addMember("script", "$S", "obj[key] = val;").build())
                .build());
        ...
        builder.addMethod(MethodSpec.methodBuilder("getProperty")
                ...
                .addParameter(jsObject, "obj")
                .addParameter(String.class, "key")
                .addAnnotation(AnnotationSpec.builder(jsBody).addMember("params", "{\"obj\", \"key\"}")
                        .addMember("script", "$S", "return obj[key];").build())
                .build());
    ...
    private void addToJsHelper(TypeSpec.Builder builder, ClassName jsObject, ClassName jsBody, Class<?> type,
            String param) {
        builder.addMethod(MethodSpec.methodBuilder("toJs")
                .addModifiers(Modifier.PRIVATE, Modifier.STATIC, Modifier.NATIVE)
                .returns(jsObject)
                .addParameter(type, param)
                .addAnnotation(AnnotationSpec.builder(jsBody).addMember("params", "$S", param)
                        .addMember("script", "$S", "return " + param + ";").build())
                .build());
    }

    private void addFromJsHelper(TypeSpec.Builder builder, ClassName jsObject, ClassName jsBody, Class<?> retType,
            String name, String script) {
        builder.addMethod(MethodSpec.methodBuilder(name)
                .addModifiers(Modifier.PRIVATE, Modifier.STATIC, Modifier.NATIVE)
                .returns(retType)
                .addParameter(jsObject, "o")
                .addAnnotation(AnnotationSpec.builder(jsBody).addMember("params", "$S", "o")
                        .addMember("script", "$S", script).build())
                .build());
    }
